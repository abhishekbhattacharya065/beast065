/*This is the code for a smart irrigation system project using Arduino UNO. We require 2 moisture sensor modules, a temperature sensor module, an US module, ESP8266 WiFi module, Valves etc.*/
