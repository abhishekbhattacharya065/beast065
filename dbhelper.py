...
class DBHelper:
    ...
    def update_profile(self,email,password,age,city,dp,user_id):
        try:
            self._mycursor.execute("UPDATE users SET email='{}', password='{}', age='{}', city='{}', dp='{}' WHERE user_id='{}'".format(email,password,age,city,dp,user_id))
            self._conn.commit()
            return 1
        except:
            return 0
    ...
    def register(self,name,email,password,age,gender,city,dp):
        try:
            self._mycursor.execute("""INSERT INTO users(user_id,name,email,password,age,gender,city,dp) VALUES(NULL, '{}','{}','{}',{},'{}','{}','{}')""".format(name,email,password,age,gender,city,dp))
            self._conn.commit()
            return 1
        except:
            return 0
